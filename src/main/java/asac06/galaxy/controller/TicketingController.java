...
public class TicketingController {
    ...
    public ResponseDto<MainPosterProductDto> productDetailElements(@PathVariable("id") Long id) {

        return new ResponseDto<MainPosterProductDto>(HttpStatus.OK.value(), ticketingService.findProductById(id));
    }
