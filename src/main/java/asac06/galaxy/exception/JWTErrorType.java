...
public enum JWTErrorType implements ErrorCode {
    ...
    INVALID_TOKEN_ERROR("I400", HttpStatus.BAD_REQUEST, "잘못된 요청입니다."),

    INVALID_REFRESH_TOKEN("R400", HttpStatus.BAD_REQUEST, "잘못된 요청입니다."),
    EXPIRED_ACCESS_TOKEN("EA401", HttpStatus.UNAUTHORIZED, "토큰이 만료되었습니다."),
    EXPIRED_REFRESH_TOKEN("ER401", HttpStatus.UNAUTHORIZED, "토큰이 만료되었습니다. 다시 로그인 해주세요.");
